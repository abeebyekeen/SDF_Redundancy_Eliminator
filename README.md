...
**Yekeen, A. A. (2022). SDF_Redundancy_Eliminator: A python code to remove redundant ligands in a .SD/.SDF compound library. <em>https://github.com/abeebyekeen/SDF_Redundancy_Eliminator</em>, DOI: doi.org/10.5281/zenodo.7049711**
